...
| `auto_hide`   | `[]`     | Automatically hide the regular menu while any listed condition is active. Supported values are `call` and `casting`.                                                                                                                                         |
...
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `call`         | The `call` menu button starts the call flow for the active camera. It only appears when the active camera has [`call.stream`](./cameras/call.md) configured, the button is enabled, no call is already active, and the current live view is not using a substream override.                                                                                                                                                                                                                           |
